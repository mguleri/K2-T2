---
title: "K-2 T2 Behavioral Exploration in R"
...
# 0. Pulling out the elision data from b2_clean to use below
b2_elision <- b2_clean %>%
  select(grade, pid, age, elision_raw)
...
ggplot(b2_elision, aes(age, elision_raw)) + 
...
ggplot(b2_elision, aes(x=age, y=elision_raw, color=grade)) + 
  geom_point() +
...
CTOPP Elision Density Plot

```{r ggplot elision density plot, echo=FALSE}
