...
1. Create another data frame with just the participant id, age, grade, and CTOPP Elision data. Try reordering the columns, like putting grade ahead of everything else.

2. Create a data frame with just 1st and 2nd grade TOWRE data. (Hint: Use filter() and logical operators)

```{r extra practice, include=FALSE}
# This is a code chunk for extra practice solutions.

# 1.
b2_elision <- b2_clean %>%
  select(grade, elision_raw, age_year, id)
