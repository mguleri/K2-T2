...
\newpage
Now, adding on more layers and specifications to enhance our scatterplot:
...
# Make a CTOPP Elision Histogram (all scores)
...
# TO-DO: Scatter (Color Raw)


# TO-DO: Density (Color Raw)
...
# TO-DO: Scatter (Letter Raw)


# TO-DO: Density (Letter Raw)
...
# TO-DO: Scatter (Color vs. Letter)


# TO-DO: Scatter (Letter vs. Elision)


# TO-DO: Scatter (Color vs. Elision)
...
p_swe_pde <- ggplot(b2_clean, aes(x = swe_raw, y = pde_raw)) + 
  ...
  labs(title = "TOWRE SWE vs. PDE (raw scores)", 
...
The W-J raw score is the number of items answered correctly before reaching the ceiing row (6 highest items that were administered are incorrect)
